...
@my_view.route ('/ebook', methods=['POST', 'GET'])
def ebook():
    if request.method == 'POST':
        ...
        payment = paypalrestsdk.Payment ({
            ...
            # Redirect URLs
            "redirect_urls": {
                "return_url": "http://pythonapps.com:1300/dashboard#/Ebook?success_onetime",
                "cancel_url": "http://pythonapps.com:1300/dashboard#/Ebook?failed_onetime"},
...
@my_view.route ('/ebookbuy', methods=['POST', 'GET'])
def ebookbuy():
    if request.method == 'POST':
