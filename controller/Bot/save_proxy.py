...
proxy=['http://127.0.0.1:22225','http://127.0.0.1:34002','http://127.0.0.1:22225','http://127.0.0.1:24000','http://127.0.0.1:34005','http://127.0.0.1:22225','http://127.0.0.1:34006','http://127.0.0.1:34007','http://127.0.0.1:34008','http://127.0.0.1:34009','http://127.0.0.1:34010','http://127.0.0.1:34011','http://127.0.0.1:22225','http://127.0.0.1:34002','http://127.0.0.1:34003','http://127.0.0.1:22225','http://127.0.0.1:34007','http://127.0.0.1:34008','http://127.0.0.1:34006','http://127.0.0.1:34002','http://127.0.0.1:22225','http://127.0.0.1:34009']
ip = "0.0.0.0:9878"
...
# proxy ={
#
# 'http':'http://127.0.0.1:34002',
# 'http':'http://127.0.0.1:24000',
# 'http':'http://127.0.0.1:22225'
#
# }
def userprofile_info(sc):
    for i,z in zip(boostlikes_users,proxy):
        print z
        ...
        link=requests.get("http://www.instagram.com/"+"".join(str(i))+"/?__a=1" ,proxies={'http':''.join(str(z))})
        link1=requests.get("http://lumtest.com/myip.json" ,proxies={'http':''.join(str(z))})
        j=json.loads(link.content)

        # print j
        # link = "https://www.instagram.com/gagan_babrah_7860/?__a=1"
        # f = requezsts.get(link,proxies={'http': 'http://10.11.4.254:3128'})
        # myfile = (link.content)

        data = json.loads(link1.content)
        print data
        print (j['user']['username'])
        cursor.execute("INSERT INTO `test`(`name`) VALUES ('234')")
        db.commit()
        # print threading.active_count()
        # threading.Timer(3.0, userprofile_info).start()
        # threading.Timer(3, self.update).start()
        # s.enter(1, 1, userprofile_info, (sc,))
